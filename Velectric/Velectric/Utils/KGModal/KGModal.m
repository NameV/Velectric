...
- (void)showWithContentView:(UIView *)contentView InBottomView:(UIView *)bottomView ispadding:(BOOL)ispadding{
    ...
    CGRect convernRect = [bottomView.superview convertRect:bottomView.frame toView:[[UIApplication sharedApplication] windows].firstObject];
    ...
    containerViewRect.origin.y = CGRectGetMaxY(convernRect);
    ...
    contentView.frame = (CGRect){padding, 0, contentView.bounds.size};
